...
{
    [CustomEditor(typeof(JoyPadController), true)]
    public class JoyPadControllerEditor : Editor
    {
        ...
        {
            EditorGUILayout.PropertyField(canvas, new GUIContent("Canvas", "Need to set canvas by pass, not get parent. it maybe on the chill of other gameobject."));
