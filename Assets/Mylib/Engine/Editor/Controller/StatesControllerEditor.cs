...
[CustomEditor(typeof(LibMasterStatesController))]
public class StatesControllerEditor : Editor
{

    private LibMasterStatesController myTarget;
    ...
    //    myTarget = (StatesController)target;
