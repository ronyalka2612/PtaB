...
[CustomEditor(typeof(LibMasterCameraController))]
public class CameraControllerEditor : Editor
{

    private LibMasterCameraController myTarget;
    ...
    //    myTarget = (LibMasterCameraController)target;
    ...
    //{
    //    Debug.Log("GameController OnValidate");
    //    ListingAttribute();
    //}
        ...
        if (Prop.NextVisible(true))
        {
            ...
            do
            {
                ...
                else if (LibUtilitiesEditor.CurString == "Tab" + (tab - 1) && LibUtilitiesEditor.IsConditional() && sizeByType==0)
                {
                    ...
                    SerializedProperty property = serializedObject.FindProperty(Prop.name).Copy();
    ...
    //{
    //    return !LibUtilitiesEditor.IsSerializable && !LibUtilitiesEditor.IsSkipingChildAttribute && !LibUtilitiesEditor.IsSkiping;
    //}
